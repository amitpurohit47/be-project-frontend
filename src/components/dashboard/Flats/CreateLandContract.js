    ...
    <div className="relative mt-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-[#f4f4f4] rounded shadow-md pr-6 pb-6 h-[325px]">
          <div className="p-4">
            <p className="text-xl mb-2 font-bold">
              Upload Residential Flat Document{" "}
              <span className="italic text-slate-500 text-xs">
                For Proof of Residential Flat Ownership
              </span>
            </p>
            <input
              type="file"
          ...
          <div className="p-4">
            <p className="text-xl mb-2 font-bold">
              Upload Residential Flat Photo{" "}
              <span className="italic text-slate-500 text-xs">
                For Residential Flat Records
              </span>
            </p>
            <input
              type="file"
        ...
        <div className="bg-[#f4f4f4] rounded shadow-md pr-6 pb-6 h-[225px]">
          <div className="p-4">
            ...
            <ul className="list-disc text-slate-800 text-sm font-semibold italic p-4">
              ...
              <li>
                After specified period Residential Flat will be transferred to
                nominee
              </li>
              <li>
