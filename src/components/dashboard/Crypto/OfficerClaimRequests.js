  ...
  return  (
    <div>
      <div className="bg-[#f4f4f4] pt-8 rounded shadow-md mb-4">
        ...
        <button onClick={() => viewToggle()} type="button" class="text-white bg-blue-700 m-5 hover:bg-blue-800  focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        {!claimView ? (<span>Change to Table View</span>) : (<span>Change to Card View</span>)}
      ...
      ) : (claimView ? (<ClaimRequestTable requests={requets}/>) :
